      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold mb-4">CodeAcademy</h2>
            <p className="text-gray-300 mb-4">
              Learn programming with our interactive courses. From beginner to advanced, 
              we've got you covered with hands-on exercises and real-world projects.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} CodeAcademy. All rights reserved.
          </p>
