  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const statsResponse = await apiClient.get('/instructor/stats');
    ...
    <div className="page-container">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-lg text-gray-600">Manage your courses and track student progress</p>
        </div>
                  ...
                  <tr key={course._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="ml-1 text-sm text-gray-900">{course.averageRating?.toFixed(1) || '-'}</span>
                        <span className="ml-1 text-sm text-gray-500">({course.ratings?.length || 0})</span>
                      </div>
                    </td>
